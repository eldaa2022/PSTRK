...
<body class="index-page">
          ...
          <div class="container position-relative d-flex align-items-center justify-content-between">
            ...
            <nav id="navmenu" class="navmenu">
              <ul>
                ...
                <li><a href="http://127.0.0.1:8000/faqPengunjung" class="active">FAQ</a></li>
              </ul>
  ...
  <main class="main">
    ...
    <section id="faq" class="faq">
        <div class="container">
            <div class="row">
                <div class="col-12 text-center mb-4 pembatas-faq">
                    <h2 class="text-pembatas">Frequently Asked Questions</h2>
            ...
            <div class="row">
                    ...
                    <div class="accordion" id="faqAccordion">
                        ...
                        <div class="card card-kurikulum border-bottom">
                            <div class="card-header" id="heading{{ $index }}">
                                <h2 class="mb-0">
                                    <button class="btn btn-link collapsed thn-ajar" type="button" data-toggle="collapse" data-target="#collapse{{ $index }}" aria-expanded="false" aria-controls="collapse{{ $index }}">
                                        {{ $faq->pertanyaan }}
                                    </button>
                                </h2>
                            </div>
                ...
                <div class="col-5 image-faq">
                    <img src="assets/img/image 64.png" alt="">
                </div>
            </div>
        </div>
    </section>
          ...
          success: function (response) {
            ...
            Swal.fire({
              ...
              setTimeout(() => {
                ...
                window.location.href = "http://127.0.0.1:8000/faqPengunjung";
