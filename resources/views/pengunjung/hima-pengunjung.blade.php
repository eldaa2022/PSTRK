            ...
            <div class="container">
                <div class="content">
                    <div class="image-container-sejarah">
                        <img src="assets/img/image 11.png" alt="Program Studi D4 Teknologi Rekayasa Komputer">
                    </div>
                    @foreach ($himas as $hima)
                    <div class="text-container-sejarah">
                        <p>{{ $hima->sejarah }}{{ $hima->deskripsi }}</p>
                    </div>
                    @endforeach
                </div>
            </div>
        ...
        <section id="visi" class="visi ">
            <div class="container">
                ...
                <div class="content-box">
                    <h2>Visi</h2>
                    <p class="description text-center">{{ $hima->visi }}</p>
                </div>
                ...
                <div class="content-box">
                    ...
                    <ul class="list-style">
                        @foreach($himas as $hima)
                        <ul>
                            @foreach($hima->misi_list as $misi)
                                <li>{{ $misi }}</li>
                            @endforeach
                        </ul>
                    @endforeach
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center mb-4 pembatas">
                <h2 class="text-pembatas">Anggota Kabinet</h2>
                <img src="assets/img/line 24.png" alt="">
            </div>
            @if($kabinets->isNotEmpty())
            <div class="col-12">
                <div class="row">
                    @foreach($kabinets as $kabinet)
                    <div class="col-6 col-md-4 col-lg-2 mb-4">
                        <div class="card kabinet-card-kecil">
                            <img src="{{ url('/storage/foto/'.$kabinet->foto) }}" class="card-img-top" alt="...">
                            <div class="card-body kabinet-card">
                                <h6 class="text-center">{{ $kabinet->nama }}</h6>
                                <p class="text-left fw-semibold" style="font-size: 12px;">{{ $kabinet->jabatan }}</p>
                                <p class="text-left" style="font-size: 12px">Tahun menjabat: {{ $kabinet->tahun }}</p>
                            </div>
                        </div>
                    </div>
                    @endforeach
          ...
          success: function (response) {
            ...
            Swal.fire({
              ...
              setTimeout(() => {
                ...
                window.location.href = "/himaPengunjung";
