        ...
        <div class="branding d-flex align-items-cente">
          ...
          <div class="container position-relative d-flex align-items-center justify-content-between">
            ...
            <nav id="navmenu" class="navmenu">
              <ul>
                <li><a href="http://127.0.0.1:8000/pengunjung" class="active">Beranda</a></li>
    ...
    <main class="main">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center mb-4 pembatas" >
                        <h2 class="text-pembatas">Prestasi</h2>
                        ...
                        <div class="col-12 mb-4">
                            <div class="card prestasi-card">
                                ...
                                <div class="card-body prestasi-card-content">
                                    ...
                                    <p class="text-muted">{{ $prestasis->first()->tgl_publish }}</p>
                                    <p class="desk">{{ $prestasis->first()->deskripsi }}</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-12 text-end">
                        <a href="http://127.0.0.1:8000/prestasiMhs" class="text-decoration-underline link-lihat">
                            LIHAT SEMUA
        ...
        <section id="vidio" class="vidio">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12 text-end">
                        <a href="http://127.0.0.1:8000/videoPengunjung" class="text-decoration-underline link-lihat2">
                            LIHAT SEMUA
                            <i class="bi bi-arrow-right"></i>
                        </a>
                    </div>
        ...
        <section id="berita" class="section bg-white py-5">
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center mb-4 pembatas" >
                        <h2 class="text-pembatas">Berita</h2>
                        <img src="assets/img/line 24.png" alt="">
                    </div>
                ...
                <div class="row">
                    <div class="col-12 text-end">
                        <a href="http://127.0.0.1:8000/beritaMhs" class="text-decoration-underline link-lihat">
                            LIHAT SEMUA
                            <i class="bi bi-arrow-right"></i>
                        </a>
                    </div>
          ...
          success: function (response) {
            ...
            Swal.fire({
              ...
              setTimeout(() => {
                ...
                window.location.href = "http://127.0.0.1:8000/pengunjung";
