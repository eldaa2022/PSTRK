            ...
            <div id="prestasiCarousel" class="carousel slide " data-ride="carousel">
                <div class="carousel-inner">
                    ...
                    <div class="presdos-carousel-item carousel-item {{ $index == 0 ? 'active' : '' }}">
                        <img src="{{ url('storage/foto/'.$berita->lampiran) }}" alt="Prestasi Image">
                        <div class="presdos-carousel-caption carousel-caption">
                            <h5 class="text-light fw-bold">{{ $berita->judul }}</h5>
                ...
                <div class="row">
                    ...
                    <div class="col-8">
                        <div class=" mb-4 pembatas-prestasi2">
                            <h5 class="text-pembatas-prestasi">Berita</h5>
                            <img src="assets/img/line 24.png" alt="">
                        </div>
                        <div class=" mb-4">
                            @foreach ($beritas as $berita)
                            <div class="card prestasi-card2">
                                <img src="{{ url('/storage/foto/'.$berita->lampiran) }}" class="img-fluid" alt="Main Image">
                                <div class="card-body prestasi-card-content2">
                                    <p class="judul-pres"><a href="{{ route('detail-berita', $berita->id) }}">{{ $berita->judul }}</a></p>
                                    <p class="text-muted mt-0 tgl-pres">{{ $berita->tgl_publish }}</p>
                                    <p class="deskpres">{{ $berita->deskripsi }}</p>
                                </div>
                            </div>
                            @endforeach
                        </div>
          ...
          success: function (response) {
            ...
            Swal.fire({
              ...
              setTimeout(() => {
                ...
                window.location.href = "http://127.0.0.1:8000/beritaMhs";
