...
<body class="index-page">
    ...
    <header id="header" class="header sticky-top">
      ...
      <main class="main">
        ...
        <!-- dosen Section -->
        <section id="dosen" class="section py-5">
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center mb-4 pembatas">
                        <h2 class="text-pembatas-akreditasi">Pengajar PSTRK</h2>
                        <img src="assets/img/line 24.png" alt="">
                    </div>

                    @foreach($dosens as $dosen)
                    <div class="col-md-4 mb-4">
                        <div class="card-dosen" style="background-image: url('{{ url('storage/foto/'.$dosen->foto) }}');">
                            <div class="card-info">
                                <h6 class="card-title fw-semibold">{{ $dosen->nama }}</h6>
          ...
          success: function (response) {
            ...
            Swal.fire({
              ...
              setTimeout(() => {
                ...
                window.location.href = "http://127.0.0.1:8000/dosenPengunjung";
...
@include('pengunjung.detail-dosen-pengunjung')
</body>
