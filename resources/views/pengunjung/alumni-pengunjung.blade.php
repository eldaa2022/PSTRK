                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 mb-4">
                                <div class="card alumni-card-kecil">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="fw-semibold" style="font-size: 14px; margin-bottom: 4px">{{ $alumni->pekerjaan }}</p>
                                        <p style="font-size: 12px">Kompetensi : {{ $alumni->kompetensi }}</p>
                                    </div>
                                </div>
                            </div>
                        @endforeach
          ...
          success: function (response) {
            ...
            Swal.fire({
              ...
              setTimeout(() => {
                ...
                window.location.href = "/alumniPengunjung";
