                        ...
                        <div class="col-8">
                            ...
                            <div class="galeri-container mb-4">
                                ...
                                <div class="galeri-item">
                                    <div class="galeri-image" onclick="openPopup('{{ url('storage/video/'.$video->lampiran) }}')">
                                        ...
                                        <div class="galeri-video-info">
                                            <h6 class="text-white">{{ $video->judul }}</h6>
                                            <p class="text-white">{{ $video->tgl_upload }}</p>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
          ...
          success: function (response) {
            ...
            Swal.fire({
              ...
              setTimeout(() => {
                ...
                window.location.href = "http://127.0.0.1:8000/videoPengunjung";
