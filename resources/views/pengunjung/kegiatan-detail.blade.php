        ...
        <section id="vidio" class="akreditasi">
            <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            <div class="content">
                                <h3 class="text-pembatas-profil justify-content-start">{{$kegiatan->judul}}</h3>
                                <div class="image-container-sejarah">
                                    <img src="{{ url('/storage/foto/'.$kegiatan->lampiran) }}" alt="Program Studi D4 Teknologi Rekayasa Komputer">
                                </div>
