                ...
                <div class="col-8">
                    <div class="row">
                        ...
                        <div class="col-12 mb-2 border-box" style="height: 50vh; position: relative;">
                            <img src="assets/img/bgLogin.png" alt="Background" style="width: 100%; height: 80%; object-fit: cover;" class="search-img">
                            <div class="search-bar-container">
                                    <input type="search" class="search-bar" name="query" class="form-control" placeholder="Cari berita, agenda, prestasi, dan lain-lain ..." value="{{ request('query') }}">
                                ...
                                <ul class="list-group list-group-flush ">
                                    ...
                                    <li class="list-group-item mt-2">
                                        <div class="media d-flex">
                                            <img src="/storage/foto/profil.png" class="mr-3 align-middle" alt="Icon" style="width: 56px; height: 56px;">
