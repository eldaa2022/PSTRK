        ...
        <div class="container">
            <div class="table-responsive">
                <div class="mt-4" style="height: 60px">
                    <form action="/photo" class="form-inline w-50 float-start" method="GET">
                        @csrf
                ...
                <table class="table">
                    ...
                    <tbody id="table-konten">
                        ...
                        <tr id="index_{{ $konten->id }}">
                            <td style="text-align: center">{{ ($photos->currentPage() - 1) * $photos->perPage() + $loop->iteration }}</td>
                            <td>{{$konten->judul}}</td>
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        ...
                        <li class="page-item {{ $photos->onFirstPage() ? 'disabled' : '' }}">
                            <a class="page-link" href="{{ $photos->previousPageUrl() }}">Previous</a>
                        </li>
                        ...
                        <li class="page-item {{ !$photos->hasMorePages() ? 'disabled' : '' }}">
                            <a class="page-link" href="{{ $photos->nextPageUrl() }}">Next</a>
                        </li>
                    </ul>
                </nav>
            </div>
