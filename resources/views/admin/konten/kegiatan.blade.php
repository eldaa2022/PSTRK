        ...
        <div class="container">
            <div class="table-responsive">
                <div class="mt-4" style="height: 60px">
                    <form action="/kegiatan" class="form-inline w-50 float-start" method="GET">
                        @csrf
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        <!-- Previous Page Link -->
                        <li class="page-item {{ $kegiatans->onFirstPage() ? 'disabled' : '' }}">
                            <a class="page-link" href="{{ $kegiatans->previousPageUrl() }}">Previous</a>
                        </li>
                        ...
                        <!-- Next Page Link -->
                        <li class="page-item {{ !$kegiatans->hasMorePages() ? 'disabled' : '' }}">
                            <a class="page-link" href="{{ $kegiatans->nextPageUrl() }}">Next</a>
                        </li>
                    </ul>
                </nav>
            </div>
