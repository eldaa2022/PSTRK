    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formEditData" enctype="multipart/form-data" method="POST"> <!-- ID diperbaiki menjadi formEditData -->
                    @method('PUT')
...
<script>
    $(document).ready(function(){
        ...
        $('#update').click(function(e) {
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    row.find('td:eq(3)').text(response.data.tgl_publish);
                    row.find('td:eq(4)').html(lampiranHtml);
        ...
        $('#judul-edit, #tags-edit, #tgl_publish-edit, #status-edit, #jenis-edit').on('input change', function() {
